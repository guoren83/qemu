...
/* XuanTie IOMMU custom capability fields */
#define RISCV_IOMMU_CAP_XT_GIPC         BIT_ULL(56)
...
/* XuanTie IOMMU custom Translation control fields */
#define RISCV_IOMMU_DC_TC_XT_GIPC       BIT_ULL(24)
